function V = UpdateV(X,U,V,S,D,L,alpha,viewNum)
...
while 1
    ...
    for i = 1:viewNum
        ...
        sumXUminus = sumXUminus + XUminus;
        sumXUplus = sumXUplus + XUplus;
        
        sumVUUplus = sumVUUplus + UUplus*V;
        sumVUUminus = sumVUUminus + UUminus*V;
    end
